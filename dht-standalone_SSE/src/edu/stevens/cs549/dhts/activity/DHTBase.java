...
public abstract class DHTBase {
	...
	/*
	 * For internal errors, unlike Failed. Also encapsulate RemoteException
	 * errors.
	 */
	...
	/*
	 * Check if the id is in a range of key values. LB is excluded, and UB is
	 * only included if the flag is true. i.e. default case for checking if id
	 * is in range for node.
	 */
